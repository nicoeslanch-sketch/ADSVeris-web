...
<title>Contraseña actualizada - ADS Veris</title></head>
<body style="margin:0;padding:0;background-color:#f5f7fa;font-family:Arial,sans-serif;">
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.08);max-width:600px;width:100%;">
        ...
        <tr>
          <td style="padding:44px 40px;">
            ...
            <h1 style="margin:0 0 20px 0;font-size:22px;font-weight:800;color:#09111f;">Contraseña actualizada correctamente ✅</h1>
            <p style="margin:0 0 16px 0;font-size:15px;color:#374151;line-height:1.7;">
              Hola <strong>${userName}</strong>,
            </p>
            <p style="margin:0 0 16px 0;font-size:15px;color:#374151;line-height:1.7;">
              Tu contraseña de <strong>ADS Veris</strong> ha sido actualizada correctamente. ¡Felicidades! 🎉
            </p>
            <p style="margin:0 0 28px 0;font-size:15px;color:#374151;line-height:1.7;">
              Ya puedes iniciar sesión con tu nueva contraseña. Si <strong>no realizaste este cambio</strong>, contacta con nuestro equipo de soporte inmediatamente.
            </p>
            <table cellpadding="0" cellspacing="0">
              <tr>
                <td style="background:linear-gradient(135deg,#c19a54,#e0c589);border-radius:8px;">
                  <a href="https://pymex-web.vercel.app/login" style="display:inline-block;padding:14px 28px;color:#09111f;font-weight:700;font-size:15px;text-decoration:none;letter-spacing:0.02em;">
                    Iniciar sesión →
                  </a>
                </td>
              </tr>
  ...
  try {
    await sgMail.send({
      ...
      subject: 'Contraseña actualizada - ADS Veris',
      html,
    })
